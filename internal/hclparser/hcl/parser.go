...
func (p *Parser) parseDirectoryFiles(files []file) (Blocks, error) { //nolint:unparam
	var blocks Blocks
...
func (p *Parser) loadVars(blocks Blocks, filenames []string) (map[string]cty.Value, error) { //nolint:unparam
