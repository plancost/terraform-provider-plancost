...
func buildVarFileEnvNames(root *TreeNode, e *EnvFileMatcher, preferFolderNameForEnv bool) {
	...
	c:
		for {
			if parent == nil { //nolint:staticcheck
				break
			}
...
func (p *ProjectLocator) removeParentTerragruntFiles(startingPath string, files []string) []string { //nolint:unused
...
func (p *ProjectLocator) processFile(name string) bool { //nolint:unused
