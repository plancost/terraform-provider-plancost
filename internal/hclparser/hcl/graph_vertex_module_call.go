...
func (v *VertexModuleCall) evaluate(e *Evaluator, b *Block, mutex *sync.Mutex) error { //nolint:unparam
...
func (v *VertexModuleCall) expand(e *Evaluator, b *Block, mutex *sync.Mutex) ([]*Block, error) { //nolint:unparam
	expanded := []*Block{b}
