...
import (
	...
	"github.com/plancost/terraform-provider-plancost/internal/hclparser/hcl/funcs"
	"github.com/plancost/terraform-provider-plancost/internal/hclparser/hcl/mock"
...
func (b BlockBuilder) NewBlock(filename string, rootPath string, hclBlock *hcl.Block, ctx *Context, parent *Block, moduleBlock *Block) *Block {
	...
	isLoggingVerbose := strings.TrimSpace(os.Getenv("PLANCOST_HCL_DEBUG_VERBOSE")) == "true"
...
// "sensible" number.
func awsSubnetsValues(b *Block) cty.Value { //nolint:unparam
	return cty.ObjectVal(map[string]cty.Value{
