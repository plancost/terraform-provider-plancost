...
func strPtr(s string) *string { //nolint:unused
	return &s
}

func decimalPtr(d decimal.Decimal) *decimal.Decimal { //nolint:unused
	return &d
}

func regexPtr(regex string) *string { //nolint:unused
...
func convertRegion(region string) string { //nolint:unused
...
func locationNameMapping(l string) string { //nolint:unused
...
func regionToVNETZone(region string) string { //nolint:unused
...
func regionToCDNZone(region string) string { //nolint:unused
	return map[string]string{
		"eastus":              "Zone 1",
		"eastus2":             "Zone 1",
		"southcentralus":      "Zone 1",
...
func intPtr(i int64) *int64 { //nolint:unused
	return &i
}

func contains(arr []string, e string) bool { //nolint:unused
	for _, a := range arr {
		if a == e {
			return true
		}
