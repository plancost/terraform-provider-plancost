...
func TestFrontdoorFirewallPolicyGoldenFile(t *testing.T) {
	t.Skip("skipping test as new Frontdoor resources cannot be created")
	t.Parallel()
	if testing.Short() {
		t.Skip("skipping test in short mode")
	}

	testcase.GoldenFileResourceTestsWithOpts(t, "frontdoor_firewall_policy_test", &testcase.GoldenFileOptions{
